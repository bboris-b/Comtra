    ...
    <div data-component="Generate: View Container" className="p-4 flex flex-col gap-4 pb-24 min-h-full relative overflow-y-auto">
      ...
      {!showReport && (
        <div data-component="Generate: Info Alert" className="bg-white border-2 border-black p-3 text-[10px] font-medium leading-tight shadow-[4px_4px_0_0_#000]">
            ...
            <ul className="list-disc list-inside space-y-1 text-gray-600">
                ...
                <li data-component="Generate: Info List Item 3"><strong>Paste Link:</strong> You can paste Figma wireframe links in the prompt to reference them.</li>
            </ul>
        </div>
      )}
      ...
      <div data-component="Generate: Selection Card" className={`${BRUTAL.card} bg-white py-2 flex flex-col gap-2 relative z-[5]`}>
        ...
        <div className="flex justify-between items-center border-b border-black/10 pb-2">
          ...
          <button data-component="Generate: Selection Toggle" onClick={() => { setSelectedLayer(selectedLayer ? null : "Hero_Section_V2"); setShowReport(false); }} className="text-[10px] font-bold bg-black text-white px-2 py-1">
        ...
        {selectedLayer ? (
          ...
          <span data-component="Generate: Selection Empty" className="text-[10px] text-gray-400 italic mb-1">No layer selected. Creating new wireframes.</span>
        )}
